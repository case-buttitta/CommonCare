...
class Location(db.Model):
    ...
    primary_color = db.Column(db.String(20), default='#780606')
    secondary_color = db.Column(db.String(20), default='#DE6464')
    header_color = db.Column(db.String(20), default='#780606')
