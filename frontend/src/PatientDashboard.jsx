              ...
              <div className="tab-panel">
                ...
                {biomarkers && Object.keys(biomarkers.latest).length > 0 ? (
                  <>
                        ...
                        return (
                          ...
                          >
                            <div className="biomarker-card-header">
                              <span className="biomarker-label">
                                {formatBiomarkerName(type)}
                              </span>
                              <span className="biomarker-inspect">
                                View Details →
                              </span>
                            </div>
                            <div className="biomarker-value">
                              {data.value}{" "}
                              <span className="biomarker-unit">
                                {data.unit}
                              </span>
                            </div>
                            {trend !== null && (
                              <div
                                className={`biomarker-trend ${trend < 0 ? "improving" : trend > 0 ? "worsening" : "stable"}`}
                              >
                                {trend < 0 ? "↓" : trend > 0 ? "↑" : "→"}{" "}
                                {Math.abs(trend).toFixed(1)} from previous
                              </div>
                            )}
                            <div className="biomarker-date">
                              Last checked:{" "}
                    ...
                    <div className="charts-section">
                      ...
                      <div className="charts-grid">
                        {Object.entries(biomarkers.history).map(
                          ([type, history]) => (
                            <BiomarkerChart
                              key={type}
                              data={history}
                  ...
                  <div className="empty-state">
                    <p>
                      No biomarker data yet. Complete an appointment to see your
                      health readings.
                    </p>
                  </div>
                )}
            ...
            {activeTab === "appointments" && (
              <div className="tab-panel">
                ...
                <h3
                  ...
                  style={
                    pendingAppointments.length > 0 ? { marginTop: "2rem" } : {}
                  }
                >
                  Past Appointments
                </h3>
                          ...
                          <div className="appointment-readings">
                            {appt.biomarker_readings.map((r) => (
                              <span key={r.id} className="reading-chip">
                                {formatBiomarkerName(r.biomarker_type)}:{" "}
                                {r.value} {r.unit}
                              </span>
                            ))}
                          </div>
        ...
        <div className="modal-overlay" onClick={() => setHistoryModal(null)}>
          ...
          >
            ...
            <table className="history-table">
              ...
              <tbody>
                {biomarkers.history[historyModal]
                  .slice()
                  .reverse()
                  .map((entry, i) => (
                    <tr key={i}>
